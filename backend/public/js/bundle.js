...
},{"axios":"../../node_modules/axios/index.js"}],"crud.js":[function(require,module,exports) {
"use strict";
...
var addOneDocument = /*#__PURE__*/function () {
  ...
  return function addOneDocument(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              form = new FormData();
              fillOutTheForm(form, 'tours', 'name', 'price', 'duration', 'difficulty', 'maxGroupSize', 'summary', 'description', 'guides');
              _context.next = 5;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              e.preventDefault();
              form = new FormData();
              fillOutTheForm(form, 'users', 'name', 'email', 'password', 'passwordConfirm', 'role');
              _context4.next = 5;
          ...
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              if (document.querySelector('#password').value !== '') {
                fillOutTheForm(form, 'users', 'photo', 'name', 'email', 'password', 'role');
              } else {
