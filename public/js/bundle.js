...
var errorMessageHandler = function errorMessageHandler(error) {
  ...
  var errorsArray;
  console.log(error); // xử lý lỗi hết vé hoặc không đủ vé khi đặt tour

  if (error !== null && error !== void 0 && error.message.startsWith('Đặt tour thất bại.')) {
    alert(error.message);
  ...
  if (((_error$error2 = error.error) === null || _error$error2 === void 0 ? void 0 : _error$error2.code) === 11000) {
    var field = Object.keys(error.error.keyValue)[0];
    var value = error.error.keyValue[Object.keys(error.error.keyValue)[0]];
    errorsArray = ["".concat(field, ": ").concat(value, " has already used. Try another one.")];
  } // xử lý lỗi chung chung


  if (error.status === 'fail' || error.status === 401) {
    errorsArray = ["commonError: ".concat(error.message)];
  } // chuyển mảng lỗi thành object


  var errorsObject = {};
  errorsArray.forEach(function (errorMessage) {
    errorsObject[errorMessage.slice(0, errorMessage.indexOf(':'))] = errorMessage.slice(errorMessage.indexOf(': ') + 2);
  });
  return errorsObject;
};
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fn.apply(void 0, _args).catch(function (error) {
              ...
              if (invalidInputs && invalidFeedbacks) {
                ...
                invalidFeedbacks.forEach(function (messageElement) {
              ...
              // Chuyển đổi error từ string sang object
              var errorsObj = errorMessageHandler(error.response.data);
              console.log(error.response.data); // Hiển thị lỗi dưới mỗi input
...
var signup = (0, _catchAsync.default)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, phoneNumber, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js","./helpers/catchAsync":"helpers/catchAsync.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmlldHBoYXR0MTkwOSIsImEiOiJjbDJneWI5N2MwMTB4M2JxNm9haDZla213In0.jQrQNVVcbktxeZ4WfKcZvw';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add marker to map: option element, anchor -> set coordinates -> add to map

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add popup to map: option offset -> set coordinates -> set html for popup -> add to map

    new mapboxgl.Popup({
      offset: 30,
      closeOnClick: false
    }).setLngLat(loc.coordinates).setHTML("Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map); // Extend map bounds to include current location
...
exports.updateOneDocument = exports.deleteOneDocument = exports.addOneDocument = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              alert("Added success!");
              location.replace("/me/manage-".concat(entity));
            }
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data, id, entity) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = "/api/v1/".concat(entity, "/").concat(id);
            _context2.next = 3;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var deleteOneDocument = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(id, entity) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
  ...
  return function deleteOneDocument(_x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();

exports.deleteOneDocument = deleteOneDocument;
},{"axios":"../../node_modules/axios/index.js","./helpers/catchAsync":"helpers/catchAsync.js"}],"helpers/fillOutTheForm.js":[function(require,module,exports) {
"use strict";
...
var fillOutTheForm = function fillOutTheForm(form, entity) {
  ...
  fields.forEach(function (field) {
    ...
    if (!excludedFields.includes(field)) {
      form.append("".concat(field), document.querySelector("#".concat(field)).value);
    }
  }); // Nêu điền form tours
  ...
  if (entity === 'tours') {
    ...
    form.append('guides', selectedGuides); // if (selectedGuides.length !== 0) {
  ...
  if (entity === 'users') {
    ...
    var photo = (_document$querySelect = document.querySelector('#photo')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.files[0];
...
var _default = fillOutTheForm;
exports.default = _default;
},{}],"helpers/getParamsObject.js":[function(require,module,exports) {
"use strict";
...
var getParamsObject = function getParamsObject() {
...
exports.previousButtonHandler = exports.nextButtonHandler = void 0;

var _getParamsObject = _interopRequireDefault(require("./helpers/getParamsObject"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var previousButtonHandler = function previousButtonHandler(previousButton, nextButton) {
  // Nếu nút chọn trang đầu tiên là 1 => ko thể có thêm các trang trước nó
  var firstPageNumberItem = +document.querySelectorAll('.page-item')[1].innerText;
  ...
  previousButton.addEventListener('click', function (e) {
    e.preventDefault(); // 2. Nếu nút prev không bị disabled => giảm các nút trang đi 1

    var pageNumberItems = document.querySelectorAll('.page-number');

    if (!previousButton.classList.contains('disabled')) {
      pageNumberItems.forEach(function (item) {
        item.setAttribute('href', item.getAttribute('href').replace("page=".concat(item.innerHTML), "page=".concat(Number(item.innerHTML) - 1)));
        item.innerText = +item.innerHTML - 1;
      }); // 3. Xóa class disabled của nút next

      nextButton.classList.remove('disabled'); // 4. Nếu nút trang đầu tiên giảm còn 1 => thêm class disabled vào nút prev
      ...
      var pageNumberParam = Number((0, _getParamsObject.default)().page);
      var currentPageNumber = pageNumberParam === 0 || pageNumberParam < 1 ? 1 : pageNumberParam;
      pageNumberItems.forEach(function (item) {
...
exports.previousButtonHandler = previousButtonHandler;

var nextButtonHandler = function nextButtonHandler(previousButton, nextButton, pageSize) {
  // 1. Nếu nút chọn trang cuối cùng bằng với trang cuối => ko thể có thêm các trang sau nó
  var lastPageNumber = +document.querySelectorAll('.page-item')[3].innerText;
  ...
  nextButton.addEventListener('click', function (e) {
    e.preventDefault(); // 2. Nếu nút next không bị disabled => tăng các nút trang thêm 1
    ...
    if (!nextButton.classList.contains('disabled')) {
      ...
      previousButton.classList.remove('disabled'); // 4. Xóa class active của nút trang đang được chọn, thêm class active vào nút trước nó

      var selectedPageNumberItem = document.querySelector('.page-item.active');
      var pageNumberParam = Number((0, _getParamsObject.default)().page);
      var currentPageNumber = pageNumberParam === 0 || pageNumberParam < 1 ? 1 : pageNumberParam;

      if (selectedPageNumberItem) {
        // Nếu nút trước nút trang được chọn bằng với trang hiện tại => thêm class active
        var previousSelectedPageNumberItem = selectedPageNumberItem.previousSibling;

        if (previousSelectedPageNumberItem && currentPageNumber === Number(previousSelectedPageNumberItem.innerText)) {
...
exports.nextButtonHandler = nextButtonHandler;
},{"./helpers/getParamsObject":"helpers/getParamsObject.js"}],"insertLocationsForm.js":[function(require,module,exports) {
"use strict";
...
var showLocationsFormButtonHandler = function showLocationsFormButtonHandler(showLocationsFormButton) {
  showLocationsFormButton.addEventListener('click', function (e) {
    var totalNumberOfLocations = +document.querySelector('input#totalNumberOfLocations').value;
    var locationsFormContainer = document.getElementById('locations-container');
...
var _default = showLocationsFormButtonHandler;
exports.default = _default;
...
var _default = (0, _catchAsync.default)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = "/api/v1/users/".concat(type === 'data' ? 'update-my-data' : 'update-my-password');
            _context.next = 3;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
exports.default = _default;
},{"axios":"../../node_modules/axios/index.js","./helpers/catchAsync":"helpers/catchAsync.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var bookTour = (0, _catchAsync.default)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    var ticketsQuantity, stripe, session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ticketsQuantity = document.getElementById('ticketsQuantity').value;
            stripe = Stripe('pk_test_51KGH6hJqNiS0Gthfv7kbDh7kzPR7jIKFMSlP9E8WtdcJcbiO4lWSQCBDr9oYeJXV6J7yKnhfV1FhUtTE70lZ5AdW00CRJPMdvj'); // 1. Lấy checkout session từ server

            _context.next = 4;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(ticketsQuantity));
...
},{"axios":"../../node_modules/axios/index.js","./helpers/catchAsync":"helpers/catchAsync.js"}],"review.js":[function(require,module,exports) {
"use strict";
...
var _default = (0, _catchAsync.default)( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(content, rating) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = "/api/v1".concat(location.pathname, "/reviews");
            _context.next = 3;
            return (0, _axios.default)({
              method: 'POST',
              url: url,
...
exports.default = _default;
},{"axios":"../../node_modules/axios/index.js","./helpers/catchAsync":"helpers/catchAsync.js"}],"autoFillRelatedField.js":[function(require,module,exports) {
"use strict";
...
var _default = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(tourSelectElement, userSelectElement) {
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            if (tourSelectElement !== '' && userSelectElement !== '') {
              tourSelectElement.addEventListener('change', /*#__PURE__*/function () {
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        ...
                        case 3:
                          ...
                          document.querySelector('input#price').value = response.data.data.data.price;
              ...
              userSelectElement.addEventListener('change', /*#__PURE__*/function () {
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 3:
                          ...
                          document.querySelector('input#phoneNumber').value = response.data.data.data.phoneNumber;
...
var _fillOutTheForm = _interopRequireDefault(require("./helpers/fillOutTheForm"));

var _pagination = require("./pagination");

var _insertLocationsForm = _interopRequireDefault(require("./insertLocationsForm"));
...
var _autoFillRelatedField = _interopRequireDefault(require("./autoFillRelatedField"));
...
var changeTourForm = document.querySelector('#change-tour-form');
var addNewTourForm = document.querySelector('#add-new-tour-form');
...
var pageSize = nextButton ? +nextButton.dataset.pageSize : undefined;
var showLocationsFormButton = document.querySelector('button#totalNumberOfLocations');
var accountSettingsForm = document.querySelector('#account-settings-form');
var passwordChangeForm = document.querySelector('#password-change-form');
var locations = document.querySelector('#map');
var bookTourBtn = document.querySelector('#booking-tour');
var reviewForm = document.querySelector('#review-form');
var tourSelectElement = document.querySelector('select#tour');
var userSelectElement = document.querySelector('select#user'); // ACTIONS
...
if (showLocationsFormButton) {
  (0, _insertLocationsForm.default)(showLocationsFormButton);
}

if (previousButton) {
  (0, _pagination.previousButtonHandler)(previousButton, nextButton);
}

if (nextButton) {
  (0, _pagination.nextButtonHandler)(previousButton, nextButton, pageSize);
} // AUTH
...
if (signupForm) {
  signupForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var name, email, phoneNumber, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 8;
              return (0, _auth.signup)(name, email, phoneNumber, password, passwordConfirm);
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              e.preventDefault();
              form = new FormData();
              (0, _fillOutTheForm.default)(form, 'users', 'name', 'email', 'phoneNumber', 'password', 'passwordConfirm', 'role');
              _context8.next = 5;
          ...
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              if (document.querySelector('#password').value !== '') {
                (0, _fillOutTheForm.default)(form, 'users', 'photo', 'name', 'email', 'phoneNumber', 'password', 'role');
              } else {
                (0, _fillOutTheForm.default)(form, 'users', 'photo', 'name', 'email', 'phoneNumber', 'role');
              }
...
if (addNewReviewForm) {
  addNewReviewForm.addEventListener('submit', /*#__PURE__*/function () {
...
if (changeReviewForm) {
  changeReviewForm.addEventListener('submit', /*#__PURE__*/function () {
          ...
          switch (_context12.prev = _context12.next) {
            case 0:
              ...
              return (0, _crud.updateOneDocument)({
                ...
                review: review,
                rating: rating
              }, document.querySelector('#review-id').value, 'reviews');
        ...
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                _context13.next = 2;
                return (0, _crud.deleteOneDocument)(btn.dataset.reviewid, 'reviews');
...
if (addNewBookingForm) {
  addNewBookingForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(e) {
      var tour, user, phoneNumber, price, ticketsQuantity, paid, approved;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              ticketsQuantity = document.querySelector('#ticketsQuantity').value;
...
if (changeBookingForm) {
  changeBookingForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(e) {
      var tour, user, phoneNumber, price, paid, approved;
        ...
        while (1) {
          switch (_context17.prev = _context17.next) {
            case 0:
              e.preventDefault();
              form = new FormData();
              (0, _fillOutTheForm.default)(form, 'users', 'email', 'name', 'phoneNumber', 'photo');
              _context17.next = 5;
        ...
        while (1) {
          switch (_context18.prev = _context18.next) {
            ...
            case 7:
              ...
              document.querySelector('button#save-new-password').textContent = 'SAVE PASSWORD';
...
var alertMessage = document.getElementsByTagName('body')[0].dataset.alert;
