  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = "http://127.0.0.1:5000/api/v1/users/".concat(type === 'data' ? 'update-my-data' : 'update-my-password');
            _context.next = 3;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
if (locations) (0, _mapbox.displayMap)(JSON.parse(locations.dataset.locations)); // ACTIONS
